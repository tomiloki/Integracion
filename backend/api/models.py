...
class Category(models.Model):
    name = models.CharField(max_length=100, verbose_name=_("Nombre de la categoria"))
...
class Product(models.Model):
    ...
    internal_code = models.CharField(max_length=50, verbose_name=_("Codigo interno"))
    name = models.CharField(max_length=200, verbose_name=_("Nombre del producto"))
    ...
    author = models.CharField(
        max_length=100,
        default="",
        help_text=_("Nombre del autor o persona que registro el producto"),
...
class Order(models.Model):
    ...
    STATUS_PAYMENT_IN_PROGRESS = "pago_en_proceso"
    ...
    STATUS_CHOICES = (
        (STATUS_PENDING, "Pendiente"),
        (STATUS_PAYMENT_IN_PROGRESS, "Pago en proceso"),
        (STATUS_COMPLETED, "Completado"),
        (STATUS_REJECTED, "Rechazado"),
        (STATUS_CANCELLED, "Cancelado"),
    )
    ...
    created_at = models.DateTimeField(auto_now_add=True, verbose_name=_("Fecha de pedido"))
    status = models.CharField(max_length=32, default=STATUS_PENDING, choices=STATUS_CHOICES)
...
class OrderItem(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name=_("Precio unitario CLP"))
...
class Payment(models.Model):
    ...
    order = models.OneToOneField(Order, on_delete=models.CASCADE, verbose_name=_("Pedido"))
    amount = models.DecimalField(max_digits=10, decimal_places=2, verbose_name=_("Monto CLP"))
    method = models.CharField(max_length=50, verbose_name=_("Metodo de pago"))
    status = models.CharField(max_length=20, default=STATUS_PENDING, choices=STATUS_CHOICES)
    paid_at = models.DateTimeField(null=True, blank=True, verbose_name=_("Fecha de pago"))
    token_ws = models.CharField(max_length=255, null=True, blank=True, verbose_name="Token Webpay")
...
class CartItem(models.Model):
    ...
    added_at = models.DateTimeField(auto_now_add=True, verbose_name=_("Fecha de agregado"))
